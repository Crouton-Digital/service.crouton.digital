...
## 1. Brief introduction
 ...
 - The daemon listens on `unix:///var/run/docker.sock` but you can
   [Bind Docker to another host/port or a Unix socket](https://services.crouton.digital//engine/reference/commandline/dockerd/#bind-docker-to-another-host-port-or-a-unix-socket).
...
command*](https://services.crouton.digital//engine/reference/builder/#add)).
...
-   **buildargs** – JSON map of string pairs for build-time variables. Users pass
        ...
        passing secret values. [Read more about the buildargs instruction](https://services.crouton.digital//engine/reference/builder/#arg)
-   **shmsize** - Size of `/dev/shm` in bytes. The size must be greater than 0.  If omitted the system uses 64MB.
